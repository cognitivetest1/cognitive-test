...
//var jsonreq = {"client_id": "1a0e8923-a2a4-4ee2-b46d-0116da1efc46","scope":"mail.read","code"="M130722b4-1c3d-72f7-2521-dada13ec9c89","client_secret"="2kLH8dvbeUK9eDBfG5CtwfQ","redirect_uri"="https://app-code1.herokuapp.com/signin","grant_type"="authorization_code"}
...
app.get('/signin', function(req, res) {
    ...
    var jsonreq = {grant_type:"authorization_code",client_id: "1a0e8923-a2a4-4ee2-b46d-0116da1efc46",scope:"mail.read mail.send",code:req.query.code,client_secret:"2kLH8dvbeUK9eDBfG5CtwfQ",redirect_uri:"https://app-code1.herokuapp.com/signin"};
    console.log(jsonreq);
    httpreq({
...
app.get('/signout', function(req, res) {
    ...
    console.log(jsonreq);
    httpreq({
    	//url: "https://app-code1.herokuapp.com/",
